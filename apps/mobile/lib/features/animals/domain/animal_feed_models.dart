final class AnimalFeedConsumption {
  ...
  factory AnimalFeedConsumption.fromJson(Map<String, dynamic> json) => AnimalFeedConsumption(
...
final class AnimalFeedHistoryLoadResult {
  ...
  factory AnimalFeedHistoryLoadResult.fromJson(Map<String, dynamic> json) => AnimalFeedHistoryLoadResult(
    items: (json['data'] as List<dynamic>)
        .map((e) => AnimalFeedConsumption.fromJson(e as Map<String, dynamic>))
        .toList(),
