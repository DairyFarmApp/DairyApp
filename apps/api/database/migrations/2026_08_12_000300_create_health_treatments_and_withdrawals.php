...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('inventory_items', function (Blueprint $table): void {
            ...
            $table->string('drap_registration_number')->nullable()->after('generic_name');
            $table->string('concentration')->nullable()->after('drap_registration_number');
            $table->unsignedInteger('milk_withdrawal_hours')->default(0)->after('concentration');
            $table->unsignedInteger('meat_withdrawal_days')->default(0)->after('milk_withdrawal_hours');
            $table->date('regulatory_verified_on')->nullable()->after('meat_withdrawal_days');
        });
